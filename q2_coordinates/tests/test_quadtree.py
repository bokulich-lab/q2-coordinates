...
class BasicTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.correct_tree = skbio.TreeNode.read(
            StringIO(
                "((('test_id_sw1':1.0)'3:1.0', ('test_id_sw2':1.0)'1:1.0')'3.:1.0',"
                "(('test_id_nw1':1.0)'1:1.0', ('test_id_nw2':1.0)'3:1.0')'1.:1.0',"
                "(('test_id_se1':1.0)'4:1.0', ('test_id_se2':1.0)'2:1.0')'4.:1.0',"
                "(('test_id_ne1':1.0)'2:1.0', ('test_id_ne2':1.0)'4:1.0')'2.:1.0')root;"))
